...
<body>
    ...
    <h2>STANDARD TRADING CONDITIONS FOR FREIGHT FORWARDERS</h2>
    <p>These are the Standard Trading Conditions applicable to the members of the Federation of Freight Forwarders’ Associations in India. These conditions do not apply when the forwarders acts as a carrier or a combined transport operator.</p>
    
    <h3>1. Definitions:</h3>
    <p>A freight forwarder (hereinafter called FORWARDER) is one who undertakes as a licensed Customs Broker, Customs Clearance and Forwarding of goods on behalf of his customer, including if necessary, procurement and coordination of one or more modes of transport. He may also undertake to perform more modes of transport. He may also undertake to perform other functions connected with the main contract such as warehousing (including storage in transit) groupage or consolidation, packing, documentation, weighing and measurement of cargo container leasing, insurance, foreign exchange transaction etc.</p>
    ...
    <h3>2. Performance of the Contract:</h3>
    ...
    <p>(d) It is understood and accepted as well as certified by the Customer that the Forwarder acting as Customs Broker is not privy to any dealings prior to and post the process of Customs Clearance.</p>
    ...
    <h3>3. Liability of the Freight Forwarder:</h3>
    <p>(a) The Forwarder is liable only for his own faults attributable to himself or his employees</p>
    <p>(b) The Forwarder shall not be liable to the customer for consequential loss or loss of market howsoever caused.</p>
    ...
    <h3>4. Right to lien and detention:</h3>
    ...
    <p>Unless expressly agreed to the contrary, claims against the Forwarder shall be decided at the principal place of his business. All the juridical relations between the Forwarder, the customer or authorized persons shall together with the application of these conditions, be regulated by Indian law.</p>

    <h3>7. Arbitration:</h3>
    <p>Any dispute between the Forwarder and the customer arising in connection with the performance of the contract shall be settled in accordance with the provision of the Indian Arbitration Act at the principal place of business of the Forwarder, each party appointing an arbitrator and the two arbitrators, in the event of disagreement appointing an umpire whose decision shall be final and binding upon both parties provided the arbitrators to be appointed under this clause shall be appointed only from the panel of arbitrators duly approved by FFFAI.</p>

    <h3>8. In case the Forwarder has to undertake warehousing of the goods, the conditions applicable will be as laid down in the Document, finalized by FFFAI and Indian Bank’s Association in September 1979.</h3>
    ...
    <p>
        BLACKSTONE SHIPPING PRIVATE LIMITED<br>
        Door no 4B/209A, First Floor North,<br>
        CGE Colony, 5th street, Tuticorin - 628003<br>
        Tamilnadu, India<br>
