const antwerpTerms = `
<body>
    <h1>Blackstone Shipping Belgium BV Terms & Conditions of Warehouse Operations</h1>
    ...
    <p>Fuel Surcharge will be adjusted on a monthly basis, based on the fuel rate of prior month customers are asked to apply for atleast 14 calender days combined free time (demurrage/detention/storage);for high volume arrivals, customers are asked to apply for 21 calender days free time. Customer guarantees to Blackstone Shipping that Blackstone Shipping will not bear any responsibility for demurrage & detention costs in case of a shorter free time period.</p>
    <p>Yearly indexation (on 1st of January) based on Belgian CPI/ITLB based on the following formula:<br>
    New tariff = Base tariff x New Index/Base Index</p>
    <ul>
        <li>(i) 'Base tariff' = the rate specified in this offer;</li>
        <li>(ii) 'Base Index' = the CPI/ITLB index of [MONTH YEAR]</li>
        <li>(iii) 'New Index' = CPI/ITLB index of December of the year prior to the year in which the indexation applies</li>
    </ul>
    ...
    <p>This offer is subject to satisfactory completion by Blackstone Shipping of its customers Due Diligence. Blackstone Shipping reserves the right to withdraw this offer at any time in the event due diligence is not completed to its satisfaction. Without prejudice to the applicability of all conditions set forth in the GSTC, please note that the Goods are not insured by Blackstone Shipping. Copy of shipping documents must be sent and pre-advised atleast 7 working days prior to estimated time of arrival of vessel. Original shipping documents shall be received atleast 5 working days prior to estimated time of arrival of vessel inorder to avoid port demurrage and/detention charges.</p>
    <p>In case of export, specified vessel shall be nominated / informed to Blackstone Shipping for acceptance with in 14 days of scheduled shipment. All charges which are stated in foreign currency to be convered to Blackstone Shipping preferred currency are according to the day-to-day exchange rates. errors and omissions excepted.</p>
</body>
`;

export default antwerpTerms;