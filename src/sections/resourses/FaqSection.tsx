...
import { FaqsData } from "src/types/graphql/types/resourses.types";

import expand from "src/assets/icons/expand.png";
import collapse from "src/assets/icons/collapse.png";

const FaqSection = ({ data }: { data: FaqsData }) => {
  const [expanded, setExpanded] = useState<number | false>(0); // First item open
