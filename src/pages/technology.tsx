...
import { GetTechnologyPageResponse } from "src/types/graphql/types/resourses.types";
    ...
    <>
      {technologyData && (
        <>
          <Banner
            bgUrl={
              technologyData?.page?.technologyPageBannerSection?.bannerImage?.node
                ?.sourceUrl
            }
            mainTitle={
          ...
          />
          <BannerContent content={technologyData?.page?.technologyPageBannerSection?.pageContent} />
          <ServiceCards data={technologyData?.technologies.nodes}/>
          <OtherTopics data={technologyData.page.technologyPageOtherTopicsSection}/>
          <Outlet />
        </>
      )}
    </>
